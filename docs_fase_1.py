...
# Conteúdo da documentação unificada e completa
conteudo_docs = """# 📘 Manual Técnico Unificado: Pipeline de Engenharia de Dados (ETL) com PySpark
...
nome_arquivo = "Manual_Tecnico_Unificado_Fase1.md"
caminho_completo = os.path.join(os.getcwd(), nome_arquivo)

try:
    with open(caminho_completo, "w", encoding="utf-8") as f:
        f.write(conteudo_docs)
    print(f"✅ Manual Técnico Unificado gerado com sucesso!")
    print(f"📂 Local: {caminho_completo}")
    print("💡 Abra no VS Code e use 'Ctrl + Shift + V' para ler formatado.")
